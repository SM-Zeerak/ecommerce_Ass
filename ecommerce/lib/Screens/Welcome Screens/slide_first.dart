  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        image: DecorationImage(image: AssetImage('assets/images/slide1.png'),
        fit: BoxFit.cover)
      ),
      child: Column(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('1',style: TextStyle(fontSize: 50,color: Colors.white,decoration: TextDecoration.none),),
                ],
              ),
            ),
    ...
    children: <TextSpan>[
      TextSpan(text: 'Jennifer Kingsley', style: 
      TextStyle(fontSize: 20,color: Colors.white,fontWeight: FontWeight.bold)),
      TextSpan(text: ' exploring the \ new range of winter fashion wear', 
